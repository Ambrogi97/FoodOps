...
export const configService = {
  ...
  uploadFondoImagen:  async (file) => uploadFile('/api/config/tienda/fondo-imagen', 'fondoImagen', file),
  deleteFondoImagen:  async ()     => request('/api/config/tienda/fondo-imagen', { method: 'DELETE' }),
